# Generated by Django 3.2.9 on 2021-12-07 00:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Drug',
            fields=[
                ('drugid', models.IntegerField(auto_created=True, default=0, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Prescriber',
            fields=[
                ('npi', models.IntegerField(default=0, primary_key=True, serialize=False, unique=True)),
