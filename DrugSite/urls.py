...
from .views import filterResultsPageView, resultsDrugPageView, statsPageView, statePageView, statesPageView
...
urlpatterns = [
    ...
    path('state/<str:ab>/', statePageView, name='state'),
    path('states/', statesPageView, name='states'),
